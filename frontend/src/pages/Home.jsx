  ...
  return (
    <div className='w-full h-screen bg-[#f7f7f8]' style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div style={{ marginTop: '64px' }}>
        <video src="../src/assets/farmeasy.mp4" autoPlay loop muted style={{ width: '100%', height: '80vh', objectFit: 'cover' }} />
      </div>
      ...
      <div className='w-full  h-screen bg-[#f7f7f8] flex   items-center'>
        <div className='w-1/2 px-2  ml-20 items-center justify-center'>
          ...
          <h2 className='text-xl text-zinc-600 mt-4'>🌱 FarmEasy is committed to empowering farmers with the right tools at the right time.
            ...
            prosperity, and a better tomorrow for every farmer. 🌾</h2>
          <button className="bg-[#2a7f62] hover:bg-[#2f6b57] text-white font-bold py-2 px-4 mt-11 rounded"><Link to="/register">Register Here</Link></button>
          </div>
        <div className='w-1/2  ml-60'>
          <img src="../src/assets/logonew.jpeg" alt="" style={{ right: '0px' }} />
        </div>
      </div>
