      ...
      <div className='flex flex-col justify-center items-center caret-transparent' >
        <div className="container flex-col  mt-24 px-4">
            ...
            <div className='flex justify-between'>
              <img className='h-40 w-40 rounded-lg border-4 shadow-sm border-green-300 hover:border-teal-500 transition duration-300' src="../src/assets/tractor.jpg" alt="" />
            ...
            <div className='flex justify-evenly space-x-96'>
              ...
              <img className='h-40 w-40 rounded-lg border-4 shadow-sm border-green-300 hover:border-teal-500 transition duration-300' src="../src/assets/logonew.jpeg" alt="" />
            </div>
