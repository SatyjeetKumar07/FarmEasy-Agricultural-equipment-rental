        ...
        <div className='w-1/4 flex-col p-4 rounded-lg'>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <Toaster
              ...
              reverseOrder={false}
            />
            <label htmlFor="name" className="text-md mb-[-10px] "></label>
            ...
            <TextField id="mobile" name='mobile no' label="Mobile No" variant="standard" value={formData.mobile} onChange={handleChange} />
            ...
            <label htmlFor="age" className="text-md mb-[-10px] "></label>
            <TextField id="age" name='age' label="Age" variant="standard" value={formData.age} onChange={handleChange} />

            <label htmlFor="role" className="text-md mb-[-10px] ">Role:</label>
            <select id="role" name="role" value={formData.role} onChange={handleChange} className="border rounded p-2 mb-4">
              <option value="farmer">Farmer (Renter)</option>
              <option value="owner">Owner (Machine Provider)</option>
            </select>

            <label htmlFor="address" className="text-md mb-[-10px] "></label>
            <TextField id="address" name='address' label="Address" variant="standard" value={formData.address} onChange={handleChange} />
            <label htmlFor="city" className="text-md mb-[-10px] "></label>
            <TextField id="city" name='city' label="City" variant="standard" value={formData.city} onChange={handleChange} />
            <label htmlFor="state" className="text-md mb-[-10px] "></label>
            <TextField id="state" name='state' label="State" variant="standard" value={formData.state} onChange={handleChange} />
            <label htmlFor="zipCode" className="text-md mb-[-10px] "></label>
